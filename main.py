...
def main():
    ...
    if choice == "Home":
        ...
        st.subheader("Model phân loại ")
        st.write("Sử dụng mô hình để dự đoán bệnh: ")
        with st.spinner("Đang thực hiện load Model..."):
            model = load_model("model/cnn_92accuracy_model.h5", compile=False)
            isLoaded = True
            pixels = 224
